...
const autoArray = [] //store values from autocomplete fetch

// *** *** FUNCTION TO FETCH AUTOFILL WORDS FROM API AND PUSH TO AUTOARRAY *** *** //
const autocompleteArray = (e) => {
...
search.addEventListener("input", autocompleteArray)
...
//   listItems.forEach((listItem) => listItem.remove()) //removes previous suggestions
...
//   let list = document.getElementsByClassName(this.id + 'suggestion')
//   e.key === "ArrowDown" ? 
// })
